...
public class JobController {
    ...
    public ResponseEntity<ApiResponse<JobDTO>> getJobById(@PathVariable Long jobId) {
        ...
        return ResponseEntity.ok(ApiResponse.success(jobDTO));
    }
    ...
    public ResponseEntity<ApiResponse<JobDTO>> createJob(@Valid @RequestBody CreateJobRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("创建成功", jobDTO));
    }
    ...
    public ResponseEntity<ApiResponse<JobDTO>> updateJob(
        ...
        return ResponseEntity.ok(ApiResponse.success("更新成功", jobDTO));
    }
